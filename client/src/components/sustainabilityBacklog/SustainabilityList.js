...
const SustainabilityList = ({
  ...
  const sustainabilityBacklog = sustainabilityBacklogStore.find(
  ...
  return (
    ...
    >
      ...
      {sustainabilityBacklog.length === 0 ? (
        ...
        >
          ...
          <Typography variant="body2">
            Drag items from the All Sustainability Initiatives column or use the
            Add New Project button above
          </Typography>
        </Box>
      ) : (
      ...
      <DropZone
        ...
        onDrop={(e) => handleDrop(e, "sustainability")}
        isDropTarget={
          dropTargetIndex === sustainabilityBacklog.length &&
          dropTargetList === "sustainability"
        }
      />
    </Paper>
  );
